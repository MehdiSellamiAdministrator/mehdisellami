public class MathOperations {
    public static void main(String[] args){
        ...
        System.out.println("With bonus marks, Ron scored " + (testScore + bonusMarks) + "/10 on his potions test. Snap wasn't too thrilled.");
        ...
        System.out.println("Snap ended up removing marks. Ron actually scored " + (testScore - bonusMarks) + " on his potions test.");

        System.out.println("Fred and George used a special spell to multiply their sweets to: " + (bagOfSweets1 * bagOfSweets2));
        System.out.println("Snaps made an error on his excel, accidentally multiplying Ron's score to: " + (testScore * bonusMarks) + "/10.");
        ...
        System.out.println("Snaps caught the error. Furious, he divided Ron's score to: " + (testScore / bonusMarks) + ".");
    }
}